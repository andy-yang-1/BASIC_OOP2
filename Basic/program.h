...
// Fill this in with whatever types and instance variables you need
    ...
    struct program_line{
        ...
        program_line() = default;
        program_line(string &a) : source_line(a) {} ;
        program_line(string &a , Statement * b ) : source_line(a) , parsed_representation(b) {} ;
    };

    map<int,program_line> all_program ;
